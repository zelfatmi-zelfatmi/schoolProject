...
<div class="relative z-20 flex items-center justify-center min-h-screen px-4 pt-24">
  <div class="bg-white bg-opacity-80 backdrop-blur-sm shadow-xl p-8 rounded-xl max-w-md w-full">
    <h2 class="text-2xl font-bold text-center text-blue-900">Connexion à votre espace</h2>
    ...
    <!-- Formulaire -->
     ...
     <a href="/forgot-password" class="font-semibold text-blue-900 hover:underline">
  Mot de passe oublié ?
</a>
...
// Référence à l'état du formulaire
    ...
    mutate(route('login'))
        .then(() => {
                ...
                console.log("connexon reussi")
                            // Inertia.visit(route('backend.parent.dashboard')); // Utilisation d'Inertia pour la redirection
