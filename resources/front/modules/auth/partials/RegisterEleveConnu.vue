...
const linkStore=formatUrl('/inscription/eleve/third-step');
const handleSubmit = () => {
    form.post(linkStore, {
        preserveScroll: true,
        onSuccess: () => {
...
<template>
        <div class="flex min-h-full flex-1 relative z-1 mix-blend-multiply mb-32">
            <div class="flex flex-1 flex-col justify-center px-4 py-12 sm:px-6 lg:px-20 xl:px-24 isolate">
                <div class="w-full max-w-md mx-auto"> 
                    <div class="mix-blend-overlay block text-black">
                        <h2 class="text-4xl font-bold l eading-9 tracking-tight">Aidez-nous à mieux vous connaître</h2>
    ...
    <div class="mt-6">
        <div>
          ...
          <div class="grid grid-cols-1 gap-3">
                              <!-- Champ texte affiché si "Autre" est sélectionné -->
                              <div v-if="form.how_know === 'Autre'">
        <TextField
            v-model="form.autre"
            label="Précisez ici"
            placeholder="Expliquez comment vous nous avez connu"
